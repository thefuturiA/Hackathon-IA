  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              className={`flex-1 sm:flex-none px-8 py-3 font-semibold rounded-lg transition-all duration-200 ${selectedFile
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <button
          onClick={toggleMute}
          className={`relative w-16 h-16 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 transform ${isMuted
        ...
        >
          ...
          {/* Badge d'état */}
          <div className={`absolute -top-1 -right-1 w-5 h-5 rounded-full border-2 border-white shadow-lg flex items-center justify-center text-xs font-bold ${isMuted ? 'bg-red-500 text-white' : 'bg-green-400 text-green-900'
            }`}>
            {isMuted ? '✕' : '♪'}
          </div>

          {/* Effet de halo */}
          <div className={`absolute inset-0 -m-2 rounded-full blur-sm animate-pulse ${isMuted
              ? 'bg-red-500/30'
              : 'bg-green-500/30'
            }`}></div>
        </button>
