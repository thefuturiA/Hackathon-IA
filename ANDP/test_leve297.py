#!/usr/bin/env python3
"""
Test spécifique pour leve297.png avec comparaison extracteur standard vs ultra-précis corrigé
"""
...
def test_leve297_comparison():
    """Test comparatif sur leve297.png"""
    
    print("🔍 TEST COMPARATIF - leve297.png")
    print("="*60)
    ...
    # Résumé du test
    print(f"\n📋 RÉSUMÉ DU TEST leve297.png:")
    print(f"   Fichier testé: leve297.png")
    print(f"   Performance standard: {len(standard_coords)} coords ({standard_completeness:.1f}%)")
    print(f"   Performance améliorée: {len(fixed_coords)} coords ({fixed_completeness:.1f}%)")
    print(f"   Résultat: {'AMÉLIORATION' if improvement > 0 else 'ÉGALITÉ' if improvement == 0 else 'RÉGRESSION'}")
...
if __name__ == "__main__":
    result = test_leve297_comparison()
